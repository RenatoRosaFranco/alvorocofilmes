...
group :development, :test do
  ...
  gem 'simplecov'
  # Use rubocop as code coverage
  gem 'rubocop'
  # Use rails_best_practices as best practices
  gem 'rails_best_practices'
  # Use foreman as procfilles
  gem 'foreman'
  # Use brakeman as system security
  gem 'brakeman'
  # Use bootstrap-sass as bootstrap
  gem 'bootstrap-sass'
  # Use jquery-rails as jquery
  gem 'jquery-rails'
  # Use rails_admin as admin
  gem 'rails_admin'
  # Use sidekiq as job
  gem 'sidekiq'
  # Use delayed job as queue job
  gem 'delayed_job'
  ...
  gem 'pundit'
  # Use friendly_id as friendly url
  gem 'friendly_id'
  # Use kaminari as pagination
  gem 'kaminari'
  # Use better_errors as error logs
  gem 'better_errors'
  # User wysiwyg-rails as text editor html
  gem "wysiwyg-rails"
  # Use draper as decorator pattern
  gem 'draper'
end
